...
To measure performance, we use the GNU time program \footnote{https://www.gnu.org/software/time/}.
...
Next, we hash the message with all approved hash messages listed in the specification (SHA-256, SHA-512, SHAKE128 and SHAKE256), sign the resulting hash and later validate that signature.
